...
statuses <- c("Renewed", "Pending", "Miniseries", "Awaiting release", "Event")
```
...
netflix_originals <- transmute(netflix_originals, 
                               ...
                               Runtime = Runtime,
                               Language = Language,
                               Status = parse_factor(only_keep(Status, "(Renewed|Pending|Miniseries|Awaiting release|Event)"), levels = statuses))
