...
```{r}
(netflix_originals <- filter_originals(netflix_originals))
...
```{r}
(amazon_originals <- filter_originals(amazon_originals))
...
```{r}
(hulu_originals <- filter_originals(hulu_originals))
...
```{r}
(disney_originals <- filter_originals(disney_originals))
...
```{r}
(apple_originals <- filter_originals(apple_originals))
