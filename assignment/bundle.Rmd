...
Because Apple TV+ only holds original content, there is no need to worry about us including it, although it is not mentioned in the movies or shows data set. One crucial piece of information we are lacking with this approach is the age restriction of the productions. Therefore we scraped the age restrictions from the [IMDb page](https://www.imdb.com/search/title/?companies=co0546168) and combined them with the data we have.
...
Now that the data set is thoroughly combined, we should add documentation to the columns to describe what they are representing.
