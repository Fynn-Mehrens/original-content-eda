...
## Add missing Apple TV+ original ratings
...
content <- mutate(content, `Age.x` = parse_factor(ages[ifelse(is.na(`Age.x`), `Age.y`, `Age.x`)], levels = ages))
...
### Change in content origin over the years
