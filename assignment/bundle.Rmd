...
Since the goal is to point out the unique trademarks of original content, there is a need to import large data sets for movies and shows that are available on streaming services, but not necessarily original content.
...
The show data set comes, in comparison to the movies data set, with fewer columns, only eleven to be precise. We are not making use of the same three columns that we did not make use of with the movies data set.
