...
In order to make it reusable for other people, we also wanted to export our final data frame for the following usage. After some further tweaks, we are also planning to publish this dataset to Kaggle.
